...
function saveSet(key: string, s: Set<number> | Set<string>) {
  try {
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => { saveSet("hadi_savedPlaces", savedPlaces); }, [savedPlaces]);
  ...
  const isSavedPlace = useCallback((id: string) => savedPlaces.has(id), [savedPlaces]);
