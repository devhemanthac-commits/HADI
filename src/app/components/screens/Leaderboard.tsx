...
const filterPills = ["This Week", "Tourists", "Guardians", "By Zone"];
...
export function Leaderboard() {
  ...
  if (activeFilter === "Tourists") filteredLeaderboard = leaderboard.filter(l => l.weeklyScore < 800);
  if (activeFilter === "Guardians") filteredLeaderboard = leaderboard.filter(l => l.weeklyScore >= 800);
