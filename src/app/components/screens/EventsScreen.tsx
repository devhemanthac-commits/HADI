...
const events: HADIEvent[] = [
  {
    ...
    venue: "Mysore Palace Grounds", dateLabel: "Apr 28, 2026", date: new Date("2026-04-28"),
  ...
  },
  {
    ...
    venue: "Jaganmohan Palace Gallery", dateLabel: "Apr 27 – May 5", date: new Date("2026-04-27"),
  ...
  },
  {
    ...
    venue: "Sri Jayachamarajendra Art Gallery", dateLabel: "May 1–10, 2026", date: new Date("2026-05-01"),
  ...
  },
  {
    ...
    venue: "Fort Area, Sayyaji Rao Rd", dateLabel: "Apr 30, 2026", date: new Date("2026-04-30"),
  ...
  },
  {
    ...
    venue: "Agrahara Lane, Old City", dateLabel: "May 3–4, 2026", date: new Date("2026-05-03"),
  ...
  },
  {
    ...
    venue: "Chamundipuram Cultural Centre", dateLabel: "May 7, 2026", date: new Date("2026-05-07"),
  ...
  },
  {
    ...
    venue: "Chamundi Hill Temple", dateLabel: "May 10, 2026", date: new Date("2026-05-10"),
