...
export function calculatePoints(input: PointCalcInput): MultiplierBreakdown {
  ...
  const total = Math.floor(base * zone * proximity * streak * bloom * buddy);

  return { base, rarity, zone, proximity, streak, bloom, buddy, total };
}
...
export const BADGE_DEFS: BadgeDef[] = [
  ...
  },
  {
    ...
    emoji: "🌿",
    description: "5 community posts with ≥10 upvotes each",
    bonusPoints: 300,
